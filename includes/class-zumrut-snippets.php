...
class Zumrut_Snippets
{
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Zumrut_Snippets_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct()
	{
		...
		$this->plugin_name = 'zumrut-snippets';
	 ...
	 *
	 * - Zumrut_Snippets_Loader. Orchestrates the hooks of the plugin.
	 * - Zumrut_Snippets_i18n. Defines internationalization functionality.
	 * - Zumrut_Snippets_Admin. Defines all hooks for the admin area.
	 * - Zumrut_Snippets_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Zumrut_Snippets_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
